...
public class GrievanceService {
    ...
    // requireEmployeeId: when non-null (employee self-service calls), the grievance
    ...
    public void cancel(String id, String loginId, String requireEmployeeId) {
        GrievanceResponse existing = requireOwned(id, loginId, "IN_PROGRESS");
        if (requireEmployeeId != null && !requireEmployeeId.equals(existing.employeeId())) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Grievance not found: " + id);
        }
