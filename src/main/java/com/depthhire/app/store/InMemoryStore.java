...
public class InMemoryStore {
  ...
  public JobResponse saveJob(String title, String seniority, String jdText, List<String> stackTags) {
    String id = UUID.randomUUID().toString();
    JobResponse job = new JobResponse(id, title, seniority, jdText, stackTags, Instant.now());
    jobs.put(id, job);
    return job;
  }
