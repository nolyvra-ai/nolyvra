...
public class InMemoryStore {
  ...
  public JobResponse saveJob(String title, String company, String jobType, String seniority, String jdText, List<String> stackTags) {
    String id = UUID.randomUUID().toString();
    JobResponse job = new JobResponse(id, title, company, jobType, seniority, jdText, stackTags, Instant.now());
    jobs.put(id, job);
    return job;
  }
  ...
  public CandidateResponse saveCandidate(String jobId, String name, String email, String linkedinUrl) {
    String id = UUID.randomUUID().toString();
    CandidateResponse c = new CandidateResponse(id, jobId, name, email, linkedinUrl, Instant.now());
    candidates.put(id, c);
