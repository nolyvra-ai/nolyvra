        ...
        <div style={{ overflow:"hidden" }}>
          <div className="nl-marq">
            {(arr=>[...arr,...arr])([
              ...
              {name:"Twilio",  bg:"#F22F46",  el:<svg width="22" height="22" viewBox="0 0 48 48"><circle cx="24" cy="24" r="24" fill="#F22F46"/><circle cx="17" cy="17" r="5" fill="#fff"/><circle cx="17" cy="17" r="2" fill="#F22F46"/><circle cx="31" cy="17" r="5" fill="#fff"/><circle cx="31" cy="17" r="2" fill="#F22F46"/><circle cx="17" cy="31" r="5" fill="#fff"/><circle cx="17" cy="31" r="2" fill="#F22F46"/><circle cx="31" cy="31" r="5" fill="#fff"/><circle cx="31" cy="31" r="2" fill="#F22F46"/></svg>},
              {name:"Lusha",   bg:"#0B0B0F",  el:<svg width="22" height="22" viewBox="0 0 48 48"><circle cx="24" cy="24" r="24" fill="#0B0B0F"/><path d="M14 20c0-8 6-14 10-14s10 6 10 14" fill="none" stroke="#fff" strokeWidth="3" strokeLinecap="round"/><circle cx="18" cy="26" r="4" fill="none" stroke="#fff" strokeWidth="2.2"/><circle cx="30" cy="26" r="4" fill="none" stroke="#fff" strokeWidth="2.2"/><line x1="22" y1="26" x2="26" y2="26" stroke="#fff" strokeWidth="2.2"/></svg>},
            ]).map(({name,bg,el},i)=>(
