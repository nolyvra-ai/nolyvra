    ...
    <div style={{ fontFamily:"'DM Sans',sans-serif", color:C.ink, background:"#fff", overflowX:"hidden" }}>
      ...
      <div ref={dashRef} style={{ maxWidth:1280,margin:"0 auto",padding:"20px 56px 60px" }}>
        <div style={{ padding:`0 ${dashPad}%`,transition:"padding .3s ease-out",position:"relative" }}>
          <div className="nl-sc-float" style={{ top:-40,left:-30 }}>
            <div style={{ fontFamily:"'DM Mono',monospace",fontSize:10,letterSpacing:".6px",color:C.indigo,textTransform:"uppercase",marginBottom:6 }}>◈ Verify</div>
          ...
          <div className="nl-sc-float" style={{ top:60,right:-50 }}>
          ...
          <div className="nl-sc-float" style={{ bottom:80,left:-60 }}>
            <div style={{ fontFamily:"'DM Mono',monospace",fontSize:10,letterSpacing:".6px",color:C.indigo,textTransform:"uppercase",marginBottom:6 }}>◌ Agent</div>
          ...
          <div className="nl-sc-float" style={{ bottom:-30,right:-20 }}>
                ...
                <main style={{ padding:"22px 26px",display:"flex",flexDirection:"column",gap:18,background:"#fff" }}>
                  ...
                  <div style={{ display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:12 }}>
                    {[
                      ...
                      {lbl:"Candidates",   val:"9",   trend:"↑ 4 this week",    up:true,  acc:false},
                      {lbl:"AI analyses",  val:"27",  trend:null,               up:null,  acc:true },
                      {lbl:"Placements",   val:"2/4", trend:"50% to target",    up:false, acc:false},
                    ].map(({lbl,val,trend,up,acc})=>(
                      <div key={lbl} style={{ background:acc?"linear-gradient(135deg,rgba(99,102,241,.10),rgba(139,92,246,.06))":C.bgSoft, border:`1px solid ${acc?"rgba(139,92,246,.25)":C.line}`,padding:14,borderRadius:10 }}>
                        ...
                        {acc
                          ? <div style={{ display:"flex",alignItems:"flex-end",gap:3,marginTop:8,height:24 }}>
                              {[30,50,45,70,55,80,65,95].map((h,i)=><span key={i} style={{ flex:1,height:`${h}%`,background:C.grad,borderRadius:2,opacity:.8,display:"block" }} />)}
                            </div>
                  ...
                  <div style={{ background:"#fff",border:`1px solid ${C.line}`,borderRadius:10,overflow:"hidden" }}>
                    ...
                    ].map(({av,bg,nm,em,role,sB,sC,stage,vB,vC,vl,sc})=>(
                      <div key={nm} style={{ display:"grid",gridTemplateColumns:"1.6fr 1.2fr .8fr 1fr 1fr",gap:14,padding:"11px 16px",borderBottom:`1px solid ${C.line}`,alignItems:"center",fontSize:12 }}>
                        ...
                        <div style={{ display:"flex",alignItems:"center",gap:8 }}>
                          <div style={{ flex:1,height:5,background:C.bgSoft,borderRadius:99,overflow:"hidden" }}>
                            <div style={{ height:"100%",width:`${sc}%`,background:C.grad,borderRadius:99 }} />
                          </div>
      ...
      <section className="nl-section" id="features" style={{ position:"relative",maxWidth:1280,margin:"0 auto",padding:"120px 56px" }}>
        ...
        <div className="nl-feat-grid" style={{ display:"grid",gridTemplateColumns:"repeat(12,1fr)",gap:18 }}>
          ...
          <article className="nl-feature" style={{ gridColumn:"span 8" }}>
            ...
            <div style={{ marginTop:22,display:"flex",flexDirection:"column",gap:8,fontFamily:"'DM Mono',monospace",fontSize:11 }}>
              {[
                ...
                <div key={src} style={{ display:"flex",alignItems:"center",gap:10,padding:"9px 12px",background:C.bgSoft,border:`1px solid ${C.line}`,borderRadius:8 }}>
                  <span style={{ color:C.muted,minWidth:80 }}>{src}</span>
                  <span style={{ flex:1,color:C.ink }}>{val}</span>
                  <span style={{ fontSize:10,padding:"2px 7px",borderRadius:5,letterSpacing:".3px",background:ok?"rgba(16,185,129,.15)":"rgba(244,63,94,.15)",color:ok?"#059669":"#DC2626" }}>{chk}</span>
                </div>
              ))}
            </div>
          </article>
          ...
          <article className="nl-feature" style={{ gridColumn:"span 4" }}>
            ...
            <div style={{ marginTop:22,display:"flex",flexDirection:"column",gap:8,fontFamily:"'DM Mono',monospace",fontSize:11 }}>
              {[
                {done:true, active:false,label:"Parse 9 CVs"},
                {done:true, active:false,label:"Cross-check claims"},
                {done:false,active:true, label:"Score fit · rank top 3"},
                {done:false,active:false,label:"Draft outreach emails"},
              ].map(({done,active,label},i)=>(
                <div key={i} style={{ display:"flex",alignItems:"center",gap:11,padding:"10px 13px",background:active?"rgba(139,92,246,.06)":C.bgSoft,border:`1px solid ${active?"rgba(139,92,246,.4)":C.line}`,borderRadius:8,color:C.ink,opacity:done?.55:1 }}>
                  <span style={{ width:18,height:18,borderRadius:"50%",background:done?"rgba(16,185,129,.2)":"rgba(99,102,241,.18)",color:done?"#059669":C.indigo,fontSize:10,fontWeight:700,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0 }}>{i+1}</span>
                  {label}
                  {active&&<span style={{ marginLeft:"auto",width:6,height:6,borderRadius:"50%",background:C.violet,boxShadow:"0 0 12px rgba(139,92,246,.5)",animation:"nlPulse 1.4s infinite",display:"inline-block" }} />}
                </div>
              ))}
            </div>
          </article>
      ...
      {/* ══════════════ FOOTER ══════════════ */}
      <footer className="lp-footer" style={{ background:"#06050B",padding:"40px 48px",display:"flex",alignItems:"center",justifyContent:"space-between",borderTop:"1px solid rgba(255,255,255,.06)" }}>
        <div style={{ display:"flex",alignItems:"center",gap:10 }}>
