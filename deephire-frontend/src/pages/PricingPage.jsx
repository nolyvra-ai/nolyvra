      ...
      <div style={{ padding:"0 48px 96px",background:"#F7F8FA" }}>
        <div style={{ maxWidth:1200,margin:"0 auto",display:"grid",gridTemplateColumns:"repeat(5,1fr)",gap:16,alignItems:"stretch" }}>
          ...
          <div className="plan-card">
            ...
            <div style={{ fontSize:12,color:"#9AA3B4",lineHeight:1.5,marginBottom:20,minHeight:36 }}>Try DeepHire free for 1 month. No credit card required.</div>
        ...
        <div style={{ maxWidth:1200,margin:"0 auto" }}>
          ...
          <div style={{ display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:20 }}>
            {[["🪙","What is a Token?","Tokens power AI analysis. Each candidate analysis consumes tokens for CV scoring, fraud detection, interview question generation and placement probability. 1 full analysis ≈ 10 tokens."],
              ...
              ["🔒","Is my data secure?","All candidate and job data is encrypted at rest and in transit. DeepHire does not store PII beyond what is needed for analysis and never shares data with third parties."],
