...
export default function LoginPage() {
  ...
  // ── Dynamic heading ────────────────────────────────────────────────────────
  const heading =
    step === 0 ? { title: "Welcome!",              desc: "Enter your email to continue to DeepHire." }  :
    step === 1 ? { title: "Enter your password",   desc: `Signing in as ${email.trim()}`               }  :
                 { title: "Ready to sign in",       desc: "Click below to access your DeepHire workspace." };
              ...
              {step >= 2 && (
                ...
                >
                  {success
                    ...
                    : <><span>Sign In to DeepHire</span><span>→</span></>
                  }
                </button>
              )}
